...
<?$APPLICATION->IncludeComponent("bitrix:form.result.new", "yanicode_webform", Array(
		...
		"SUCCESS_URL" => "/services.php",	// Страница с сообщением об успешной отправке
    ...
    <script src="<?=SITE_TEMPLATE_PATH?>/js/vendor/inputmask.min.js"></script>
